...
/***/ function(module, exports, __webpack_require__) {
	...
	var transitionalDefaults = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.GroupSelect = exports.GroupList = undefined;
	...
	var GroupList = function GroupList(_ref2) {
	    var groups = _ref2.groups,
	        removeGroup = _ref2.removeGroup;
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            ...
	            groups.map(function (group) {
	                return _react2.default.createElement(GroupItem, { group: group, removeGroup: removeGroup });
	            })
	        )
	    );
	};
	
	var GroupSelect = function GroupSelect(_ref3) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _GroupForm = __webpack_require__(39);
	
	var _GroupForm2 = _interopRequireDefault(_GroupForm);
	
	var _reactRouterDom = __webpack_require__(4);
	
	var _UserForm = __webpack_require__(40);
	...
	var App = function (_React$Component) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function loadData() {
	            ...
	            _axios2.default.get('http://127.0.0.1:8000/api/users/').then(function (response) {
	            ...
	            _axios2.default.get('http://127.0.0.1:8000/api/groups/').then(function (response) {
	        ...
	        value: function createGroup(name, description) {
	            _axios2.default.post('http://127.0.0.1:8000/api/groups/', { 'name': name, 'description': description }).then(function (response) {}).catch(function (error) {
	                return console.log(error);
	            });
	        }
	    }, {
	        key: 'removeGroup',
	        value: function removeGroup(_id) {
	            _axios2.default.delete('http://127.0.0.1:8000/api/groups/' + _id).then(function (response) {
	        ...
	        key: 'createUser',
	        value: function createUser(group_id, username) {
	            _axios2.default.post('http://127.0.0.1:8000/api/users/', { 'group': group_id, 'username': username }).then(function (response) {}).catch(function (error) {
	                return console.log(error);
	            });
	        }
	    }, {
	        ...
	        value: function removeUser(_id) {
	            _axios2.default.delete('http://127.0.0.1:8000/api/users/' + _id).then(function (response) {
	                window.location.assign('/');
	            }).catch(function (error) {
	                return console.log(error);
	            });
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            null,
	                            _react2.default.createElement(_reactRouterDom.Route, { path: '/', element: _react2.default.createElement(_Users2.default, { users: this.state.users, removeUser: this.removeUser }) }),
	                            _react2.default.createElement(_reactRouterDom.Route, { path: '/groups', element: _react2.default.createElement(_Groups.GroupList, { groups: this.state.groups, removeGroup: this.removeGroup }) }),
	                            _react2.default.createElement(_reactRouterDom.Route, { path: '/groups/create/:id', ex: true, element: _react2.default.createElement(_GroupForm2.default, { createGroup: this.createGroup }) }),
	                            _react2.default.createElement(_reactRouterDom.Route, { path: '/users/create/:id', element: _react2.default.createElement(_UserForm2.default, { groups: this.state.groups, createUser: this.createUser }) })
	                        )
	                    )
	                )
	            );
	    ...
	    _createClass(GroupForm, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement("input", { type: "text", name: "description", placeholder: "description", value: this.state.description,
	                    onChange: function onChange(event) {
	                        return _this2.handleChange(event);
	                    } }),
	                _react2.default.createElement("input", { type: "submit", value: "Add Group" })
	            );
	        }
	    }]);
	    ...
	    _createClass(UserForm, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    "select",
	                    { name: "group_id", value: this.state.group_id, onChange: function onChange(event) {
	                            return _this2.handleChange(event);
	                        } },
	                    _react2.default.createElement(_Groups.GroupSelect, { groups: this.props.groups })
	                ),
	                _react2.default.createElement("input", { type: "text", name: "username", placeholder: "username", value: this.state.username,
	                    onChange: function onChange(event) {
	                        return _this2.handleChange(event);
	                    } }),
	                _react2.default.createElement("input", { type: "submit", value: "Add User" })
	            );
	        }
	    }]);
	    ...
	    return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	            ...
	            users.map(function (user) {
	                return _react2.default.createElement(UserItem, { user: user, removeUser: removeUser });
	            })
	        )
	    );
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	'use strict';var aa=__webpack_require__(2),m=__webpack_require__(6),r=__webpack_require__(57);function y(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(y(227));var ba=new Set,ca={};function da(a,b){ea(a,b);ea(a+"Capture",b)}
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * LICENSE file in the root directory of this source tree.
	 */
	'use strict';var l=__webpack_require__(6),n=60103,p=60106;exports.Fragment=60107;exports.StrictMode=60108;exports.Profiler=60114;var q=60109,r=60110,t=60112;exports.Suspense=60113;var u=60115,v=60116;
...
/***/ }
/******/ ])));
//# sourceMappingURL=main.34e27b26.js.map